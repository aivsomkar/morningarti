      ...
      <g clipPath="url(#frame)">
        ...
        <g>
          ...
          <path
            ...
            opacity="0.9"
          />
          <text className="banner__sub" x="800" y="98" textAnchor="middle">
            ढोल वाजतोय · गुलाल उडतोय · गल्ली नाचतेय
          </text>
          <text className="banner__mark" x="800" y="168" textAnchor="middle">
            गणपती बाप्पा
          </text>
          <text className="banner__mark banner__mark--gold" x="800" y="238" textAnchor="middle">
            मोरया
          </text>
        ...
        <g>
          {bursts.map((b) => (
            <circle
              ...
              r="30"
              fill={b.c}
              style={{ ["--dx" as string]: `${b.dx}px`, ["--dy" as string]: `${b.dy}px` }}
            />
          ))}
        </g>
      </g>
